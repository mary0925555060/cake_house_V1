...
if(isset($_POST['MM_update']) && $_POST['MM_update'] == "UPDATE"){
  $sql= "UPDATE customer_order SET publishedDate =:publishedDate,
            title = :title,
            content = :content,
          ...
          <div class="col-md-12">
            <form class="form-horizontal" role="form" data-toggle="validator" action="edit.php" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="publishedDate" name="publishedDate" required value="<?php echo $customer_order['publishedDate']; ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="title" name="title" data-error="請輸入標題" required value="<?php echo $customer_order['title']; ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="content" name="content" ><?php echo $customer_order['content']; ?></textarea>
