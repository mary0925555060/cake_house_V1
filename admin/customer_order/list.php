...
$query = $db->query("SELECT * FROM customer_order ORDER BY OrderDate DESC LIMIT ".$start_from.",".$limit);
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="edit.php?customer_orderID=<?php echo $row['customer_orderID'];?>">編輯</a></td>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <?php  if($totalRows > 0){
                $sth = $db->query("SELECT * FROM customer_order ORDER BY PublishedDate DESC ");
